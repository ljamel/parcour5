...
<div id="slide">
    ...
    <div id="img-slide2" >
        <div class="texte-slide2">
            <p>Remplissez le formulaire si dessous et decouvrez les loisirs, lieux touristiques et séjours que vous pouvez faire.</p>
            <p class="rectangle">Bon plans</p>
        </div>
    </div>
...
<div id="formulaire-recherche">
    <input placeholder="Départ"><input placeholder="Budget" type="selector"><input type="text" id="datepicker" id="from" name="from" placeholder="Du"> <input type="text" id="to" name="to" placeholder="Au"> <input class="recherche" value="Chercher" type="button">
</div>
<section id="main">
